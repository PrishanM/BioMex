...
public class AppInjector {
    ...
    public static void init(ApplicationController applicationController) {

        DaggerAppComponent.builder().application(applicationController).build().inject(applicationController);
